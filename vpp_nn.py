...
test2_csv = 'data2/testr.csv' 
predicted_degrees = predict_degrees_from_csv(test2_csv, window_size, model)

gt = [180, 180, 180, 180, 180, 160, 10, 90, 180, 180, 170, 110, 90, 90, 85, 45, 20, 0, 0, 30, 80, 90, 90, 135, 150, 170, 180, 
               180, 180, 180, 180, 100, 90, 90, 90, 80, 45, 45, 40, 0, 0, 0, 0, 0, 70, 90, 90, 135, 180, 180, 180, 180, 170, 110,
               90, 60, 30, 0, 0, 0, 30, 80, 90, 110, 120, 160, 170, 180, 180, 180, 180, 160, 100, 90, 80, 60, 0, 0, 0, 0, 0, 0, 0,
               0, 70, 90, 90, 90, 90, 90]
...
with open('subject1.pkl','wb') as f:
